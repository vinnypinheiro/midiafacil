...
@Component({
 selector: 'gov-procurador-form', 
 templateUrl: './procurador-form.component.html', 
 //styleUrls: ['./procurador-form.component.css'] 
}) 
export class ProcuradorFormComponent extends CommonsForm<Procurador> implements OnInit { 

    constructor(apiService: ProcuradorService, 
 ...
 router: Router ) { 
     ...
     onButtonActionClick(): void { 
         //console.log(this.activeBean.procurador.id); 
     } 
} 
